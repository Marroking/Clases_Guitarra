...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { calificacion: @alumno.calificacion, grado: @alumno.grado, grupo: @alumno.grupo, nombre: @alumno.nombre }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { calificacion: @alumno.calificacion, grado: @alumno.grado, grupo: @alumno.grupo, nombre: @alumno.nombre }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
