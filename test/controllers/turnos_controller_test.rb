...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { alumno: @turno.alumno, comentario: @turno.comentario, evaluacion: @turno.evaluacion, fecha: @turno.fecha, hora: @turno.hora }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { alumno: @turno.alumno, comentario: @turno.comentario, evaluacion: @turno.evaluacion, fecha: @turno.fecha, hora: @turno.hora }
    assert_redirected_to turno_path(assigns(:turno))
  end
